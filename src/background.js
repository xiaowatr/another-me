...
export const ACTIVE_FIELDS=['choiceReason','realityOutcome','hypotheticalDirection','birthYear','forkAge','gender','locationText','mbti','details','followupKey','followupQuestion','followupAnswer','followupSkipped'];
