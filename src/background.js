...
export const ACTIVE_FIELDS=['realityOutcome','hypotheticalDirection','birthYear','forkAge','gender','locationText','mbti','details','followupKey','followupQuestion','followupAnswer','followupSkipped'];
