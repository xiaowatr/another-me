...
export const ACTIVE_FIELDS=['coreConfirmAttempts','supplementary','clarificationAppliedAnswer','clarificationOriginal','lifeSituation','choiceReason','realityOutcome','hypotheticalDirection','birthYear','forkAge','gender','locationText','mbti','details','followupKey','followupQuestion','followupAnswer','followupSkipped'];
