...
export const OPENING_AUDIENCE={speaker:'parallelCharacter',recipient:'realUser',rule:'opening是写给现实自己的新消息，不是故事人物之间的对白。正文中向朋友、室友等第三人说的感谢、道歉或邀约，不能直接搬来对现实自己说。提到第三人时用姓名或关系称谓；感谢室友的陪伴，不能变成向现实自己说“谢谢你当时陪我”。尚无与现实聊天者共同见面、安慰或陪伴的聊天历史。'};
