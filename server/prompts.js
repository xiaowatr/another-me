...
export const PROMPT_VERSION='2026-09-26.v40';
...
分岔前只共享用户明确经历；choiceReason为空时动机未知，不填补为现实理由；出生条件等非主动选择无需理由。不能从职业、考试、城市或MBTI推断家乡、家庭、学历、收入、婚恋、童年、毕业状态、原单位或选择动机。用户明确的发展方向、偏好和取舍优先于生成的设定与旧回复：让它们体现在行动、时间分配和话题中，不机械复述标签，也不凭一句偏好概括人格。学习不自动意味着高考、考研、拿学历或毕业入职；没有明确目标时写具体阅读、练习、尝试和安排即可。不要默认毕业后找普通工作、恋爱结婚，不把工作、创作、学习和亲密关系强设为互斥；未明确舍弃的活动保持可能。可以好奇另一条路，不能断言现实用户因此放弃过什么。用户已经明确的选择、否定和保留条件是整篇前提，不能为制造反转、安慰或降低代价而在结尾撤回；例如辞职与请长假不是同一个决定。逐章对照同一次决定是否一直成立，区分现实对照、尚未实施的计划和这条人生已经发生的行动。分岔后可创作符合这些选择的日常，但不倒灌成现实。criticalFacts中的用户明确事件优先于生成片段、旧回复和虚构记忆；仅hypotheticalDirection明确改写该事件才可改变它。愿望和承诺不等于实现。回忆里的年龄不能超过叙述时年龄，过去事件不能说成现在刚发生。未知年限省略，时间线必须自洽。最新明确纠正优先。confirmedMemories分现实、偏好和虚构，不得混用或恢复已删除旧信息。
